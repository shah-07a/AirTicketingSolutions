...
namespace HttpServices.Helpers
{
    ...
    {
        public SearchResponseBaseModel SetFareRules(string _searchResponse, string _requestId, string _domainname, int _userid, int _defaultcompanyid, int _userroleid)
        {                       
            DataSet dataSet = GetDbData(_domainname, _userid, _defaultcompanyid, _userroleid);
            //===List<Models.DTO.Airlines> lstAirlines = GetAirlines(dataSet.Tables[0]);
            List<Models.DTO.BlockedAirlines> lstBlockedAirlines = GetBlockedAirlines(dataSet.Tables[1]);
            ...
            try
            {
                ...
                searchResponse.RequestId = _requestId;
                    ...
                    SearchResponseBaseModel.OTAAirLowFareSearchRS1.Warnings1 objWarnings1 = new SearchResponseBaseModel.OTAAirLowFareSearchRS1.Warnings1();
                    
                    foreach (var item in searchResponse.OTA_AirLowFareSearchRS.Warnings.Warning)
                    {
                        objWarnings1.Warning.Add(new SearchResponseBaseModel.OTAAirLowFareSearchRS1.Warnings1.Warning1
                        {
                            Code = item.Code,
                    ...
                    objOTA.Warnings.Add(objWarnings1);
                    ...
                    foreach (var item1 in searchResponse.OTA_AirLowFareSearchRS.PricedItineraries.PricedItinerary)
                    {
                      ...
                      //===  List<OriginDestinationOption1.FlightSegment1> lstFlightSegment = new List<OriginDestinationOption1.FlightSegment1>();
                       //=== OriginDestinationOption1.FlightSegment1 objFlightSegment = new OriginDestinationOption1.FlightSegment1();
                        objPricedItinerary1.SequenceNumber = item1.SequenceNumber;
                        objAirItinerary1.DirectionInd = item1.AirItinerary.DirectionInd;
                       //=== objOriginDestinationOption1.ElapsedTime = item1.AirItinerary.OriginDestinationOptions.OriginDestinationOption[0].ElapsedTime;
                        
                        int cont = item1.AirItinerary.OriginDestinationOptions.OriginDestinationOption.Count;

                            foreach (var item_1 in item1.AirItinerary.OriginDestinationOptions.OriginDestinationOption) //=== searchResponse.OTA_AirLowFareSearchRS.PricedItineraries.PricedItinerary[0].AirItinerary.OriginDestinationOptions.OriginDestinationOption)
                            {
                                OriginDestinationOption1 objOriginDestinationOption1 = new OriginDestinationOption1();
                                objOriginDestinationOption1.ElapsedTime = item_1.ElapsedTime;
                                List<OriginDestinationOption1.FlightSegment1> lstFlightSegment = new List<OriginDestinationOption1.FlightSegment1>();
                                foreach (var item in item_1.FlightSegment) //=== searchResponse.OTA_AirLowFareSearchRS.PricedItineraries.PricedItinerary[0].AirItinerary.OriginDestinationOptions.OriginDestinationOption[i].FlightSegment)
                            {
                                 int idx = 0;
                                lstFlightSegment.Add(new OriginDestinationOption1.FlightSegment1
                                {
                                    ...
                                    DisclosureAirline = new List<OriginDestinationOption1.FlightSegment1.DisclosureAirline1>()
                                        {
                                            new OriginDestinationOption1.FlightSegment1.DisclosureAirline1
                                            {
                                                 Code = item.DisclosureAirline != null ? item.DisclosureAirline.Code : "",
                                                 content = item.DisclosureAirline != null ? item.DisclosureAirline.content : ""
                                            }
                                        },
                                    DepartureTimeZone = new List<OriginDestinationOption1.FlightSegment1.DepartureTimeZone1>()
                                        {
                                            new OriginDestinationOption1.FlightSegment1.DepartureTimeZone1
                                            {
                                                 GMTOffset = item.DepartureTimeZone.GMTOffset
                                            }
                                        },
                                    ArrivalTimeZone = new List<OriginDestinationOption1.FlightSegment1.ArrivalTimeZone1>()
                                        {
                                            new OriginDestinationOption1.FlightSegment1.ArrivalTimeZone1
                                            {
                                                GMTOffset = item.DepartureTimeZone.GMTOffset
                                            }
                                        },
                                    TPA_Extensions = new List<OriginDestinationOption1.FlightSegment1.TPA_Extensions1>()
                                        {
                                            new OriginDestinationOption1.FlightSegment1.TPA_Extensions1
                                            {
                                                 eTicket = new List<OriginDestinationOption1.FlightSegment1.TPA_Extensions1.ETicket1>()
                                                 {
                                                  ...
                                                  Mileage = new List<OriginDestinationOption1.FlightSegment1.TPA_Extensions1.Mileage1>()
                                                  {
                                                      new OriginDestinationOption1.FlightSegment1.TPA_Extensions1.Mileage1
                                                      {
                                                          Amount = item.TPA_Extensions.Mileage.Amount
                                                      }
                                                  }
                                            }
                                        }
                        ...
                        if (adtTotalFare > 0)
                        {
                            foreach (var item4 in item1.AirItineraryPricingInfo)
                            {
                                ...
                                AirItineraryPricingInfo.ItinTotalFare1.BaseFare1 objBaseFare1 = new AirItineraryPricingInfo.ItinTotalFare1.BaseFare1
                                {
                                    Amount = item4.ItinTotalFare.BaseFare.Amount,
                                    CurrencyCode = item4.ItinTotalFare.BaseFare.CurrencyCode,
                                    DecimalPlaces = item4.ItinTotalFare.BaseFare.DecimalPlaces
                                };
                                objItinTotalFare1.BaseFare.Add(objBaseFare1);
                                AirItineraryPricingInfo.ItinTotalFare1.FareConstruction1 objFareConstruction1 = new AirItineraryPricingInfo.ItinTotalFare1.FareConstruction1
                                {
                                    Amount = item4.ItinTotalFare.FareConstruction.Amount,
                                    CurrencyCode = item4.ItinTotalFare.FareConstruction.CurrencyCode,
                                    DecimalPlaces = item4.ItinTotalFare.FareConstruction.DecimalPlaces
                                };
                                objItinTotalFare1.FareConstruction.Add(objFareConstruction1);
                                ...
                                foreach (var item5 in item4.PTC_FareBreakdowns.PTC_FareBreakdown)
                                {
                                    ...
                                    PTC_FareBreakdowns.PTC_FareBreakdown1.FareBasisCodes1 objFareBasisCodes1 = new PTC_FareBreakdowns.PTC_FareBreakdown1.FareBasisCodes1();
                                    foreach (var item6 in item5.FareBasisCodes.FareBasisCode)
                                    {
                                        objFareBasisCodes1.FareBasisCode.Add(new PTC_FareBreakdowns.PTC_FareBreakdown1.FareBasisCodes1.FareBasisCode1
                                        {
                                            BookingCode = item6.BookingCode,
                                            DepartureAirportCode = item6.DepartureAirportCode,
                                            ArrivalAirportCode = item6.ArrivalAirportCode,
                                            FareComponentBeginAirport = item6.FareComponentBeginAirport,
                                            FareComponentEndAirport = item6.FareComponentEndAirport,
                                            FareComponentDirectionality = item6.FareComponentDirectionality,
                                            FareComponentVendorCode = item6.FareComponentVendorCode,
                                            GovCarrier = item6.GovCarrier,
                                            content = item6.content,
                                            AvailabilityBreak = item6.AvailabilityBreak ?? false,
                                            PassengerType = item5.PassengerTypeQuantity.Code
                                        });
                                    }
                                    objPTC_FareBreakdown1.FareBasisCodes.Add(objFareBasisCodes1);

                                    PassengerFare objPassengerFare = new PassengerFare();
                                    PassengerFare.BaseFare2 objBaseFare2 = new PassengerFare.BaseFare2
                                    {
                                        Amount = item5.PassengerFare.BaseFare.Amount,
                                        CurrencyCode = item5.PassengerFare.BaseFare.CurrencyCode,
                                        PassengerType = item5.PassengerTypeQuantity.Code
                                    };
                                    objPassengerFare.BaseFare.Add(objBaseFare2);
                                    PassengerFare.FareConstruction2 objFareConstruction2 = new PassengerFare.FareConstruction2
                                    {
                                        Amount = item5.PassengerFare.FareConstruction.Amount,
                                        CurrencyCode = item5.PassengerFare.FareConstruction.CurrencyCode,
                                        DecimalPlaces = item5.PassengerFare.FareConstruction.DecimalPlaces,
                                        PassengerType = item5.PassengerTypeQuantity.Code
                                    };
                                    objPassengerFare.FareConstruction.Add(objFareConstruction2);
                                    ...
                                    int txCont2 = item5.PassengerFare.Taxes != null ? item5.PassengerFare.Taxes.Tax.Count : 0;
                                    for (int i1 = 0; i1 < txCont2; i1++)
                                    {
                                        PassengerFare.Taxes2.Tax2 objTax2 = new PassengerFare.Taxes2.Tax2
                                        {
                                            TaxCode = item5.PassengerFare.Taxes.Tax[i1].TaxCode,
                                            Amount = item5.PassengerFare.Taxes.Tax[i1].Amount,
                                            CurrencyCode = item5.PassengerFare.Taxes.Tax[i1].CurrencyCode,
                                            DecimalPlaces = item5.PassengerFare.Taxes.Tax[i1].DecimalPlaces,
                                            content = item5.PassengerFare.Taxes.Tax[i1].content,
                                            CountryCode = item5.PassengerFare.Taxes.Tax[i1].CountryCode ?? "",
                                            PassengerType = item5.PassengerTypeQuantity.Code
                                        };
                                        objTaxes2.Tax.Add(objTax2);
                                    }
                                    int txCont3 = item5.PassengerFare.Taxes != null ? item5.PassengerFare.Taxes.TaxSummary.Count : 0;
                                    for (int i1a = 0; i1a < txCont3; i1a++)
                                    {
                                        PassengerFare.Taxes2.TaxSummary1 objTaxSummary1 = new PassengerFare.Taxes2.TaxSummary1
                                        {
                                            TaxCode = item5.PassengerFare.Taxes.TaxSummary[i1a].TaxCode,
                                            Amount = item5.PassengerFare.Taxes.TaxSummary[i1a].Amount,
                                            CurrencyCode = item5.PassengerFare.Taxes.TaxSummary[i1a].CurrencyCode,
                                            DecimalPlaces = item5.PassengerFare.Taxes.TaxSummary[i1a].DecimalPlaces,
                                            content = item5.PassengerFare.Taxes.TaxSummary[i1a].content,
                                            CountryCode = item5.PassengerFare.Taxes.TaxSummary[i1a].CountryCode ?? "",
                                            PassengerType = item5.PassengerTypeQuantity.Code
                                        };
                                        objTaxes2.TaxSummary.Add(objTaxSummary1);
                                    }
                                ...
                                if (adtAFTotalFare > 0 || jcbTotalFare > 0 || itxTotalFare > 0)
                                    {
                                        ...
                                        foreach (var itemAF in item1.TPA_Extensions.AdditionalFares)
                                        {
                                            if (faretyp == itemAF.AirItineraryPricingInfo.PTC_FareBreakdowns.PTC_FareBreakdown[0].PassengerTypeQuantity.Code)
                                            {
                                                ...
                                                AF_AirItineraryPricingInfo.AF_ItinTotalFare1.AF_BaseFare1 AF_BaseFare1 = new AF_AirItineraryPricingInfo.AF_ItinTotalFare1.AF_BaseFare1
                                                {
                                                    Amount = itemAF.AirItineraryPricingInfo.ItinTotalFare.BaseFare.Amount,
                                                    CurrencyCode = itemAF.AirItineraryPricingInfo.ItinTotalFare.BaseFare.CurrencyCode,
                                                    DecimalPlaces = itemAF.AirItineraryPricingInfo.ItinTotalFare.BaseFare.DecimalPlaces
                                                };
                                                objAF_ItinTotalFare1.BaseFare.Add(AF_BaseFare1);
                                                AF_AirItineraryPricingInfo.AF_ItinTotalFare1.AF_FareConstruction1 objAF_FareConstruction1 = new AF_AirItineraryPricingInfo.AF_ItinTotalFare1.AF_FareConstruction1
                                                {
                                                    Amount = itemAF.AirItineraryPricingInfo.ItinTotalFare.FareConstruction.Amount,
                                                    CurrencyCode = itemAF.AirItineraryPricingInfo.ItinTotalFare.FareConstruction.CurrencyCode,
                                                    DecimalPlaces = itemAF.AirItineraryPricingInfo.ItinTotalFare.FareConstruction.DecimalPlaces
                                                };
                                                objAF_ItinTotalFare1.FareConstruction.Add(objAF_FareConstruction1);
                                                ...
                                                foreach (var itemAF1 in itemAF.AirItineraryPricingInfo.PTC_FareBreakdowns.PTC_FareBreakdown)
                                                {
                                                    if (itemAF.AirItineraryPricingInfo.PTC_FareBreakdowns.PTC_FareBreakdown[0].PassengerTypeQuantity.Code == passengerTypeQuantityCode)
                                                    {
                                                        ...
                                                        AF_PassengerFare.AF_BaseFare2 objAF_BaseFare2 = new AF_PassengerFare.AF_BaseFare2
                                                        {
                                                            Amount = itemAF1.PassengerFare.BaseFare.Amount,
                                                            CurrencyCode = itemAF1.PassengerFare.BaseFare.CurrencyCode,
                                                            PassengerType = itemAF1.PassengerTypeQuantity.Code
                                                        };
                                                        objAF_PassengerFare.BaseFare.Add(objAF_BaseFare2);
                                                        AF_PassengerFare.AF_FareConstruction2 objAF_FareConstruction2 = new AF_PassengerFare.AF_FareConstruction2
                                                        {
                                                            Amount = itemAF1.PassengerFare.FareConstruction.Amount,
                                                            CurrencyCode = itemAF1.PassengerFare.FareConstruction.CurrencyCode,
                                                            DecimalPlaces = itemAF1.PassengerFare.FareConstruction.DecimalPlaces,
                                                            PassengerType = itemAF1.PassengerTypeQuantity.Code
                                                        };
                                                        objAF_PassengerFare.FareConstruction.Add(objAF_FareConstruction2);
                                                        ...
                                                        {
                                                            txCont2 = itemAF1.PassengerFare.Taxes.Tax.Count;
                                                        }
                                                        for (int i1 = 0; i1 < txCont2; i1++)
                                                        {
                                                            AF_PassengerFare.AF_Taxes2.AF_Tax2 objAF_Tax2 = new AF_PassengerFare.AF_Taxes2.AF_Tax2
                                                            {
                                                                TaxCode = itemAF1.PassengerFare.Taxes.Tax[i1].TaxCode,
                                                                Amount = itemAF1.PassengerFare.Taxes.Tax[i1].Amount,
                                                                CurrencyCode = itemAF1.PassengerFare.Taxes.Tax[i1].CurrencyCode,
                                                                DecimalPlaces = itemAF1.PassengerFare.Taxes.Tax[i1].DecimalPlaces,
                                                                content = itemAF1.PassengerFare.Taxes.Tax[i1].content,
                                                                CountryCode = itemAF1.PassengerFare.Taxes.Tax[i1].CountryCode ?? "",
                                                                PassengerType = itemAF1.PassengerTypeQuantity.Code
                                                            };
                                                            objAF_Taxes2.Tax.Add(objAF_Tax2);
                                                        }
                                                        int txCont3 = 0;
                                                        if (itemAF1.PassengerFare.Taxes != null)
                                                        {
                                                            txCont3 = itemAF1.PassengerFare.Taxes.TaxSummary.Count;
                                                        }

                                                        for (int i1a = 0; i1a < txCont3; i1a++)
                                                        {
                                                            AF_PassengerFare.AF_Taxes2.AF_TaxSummary1 objAF_TaxSummary1 = new AF_PassengerFare.AF_Taxes2.AF_TaxSummary1
                                                            {
                                                                TaxCode = itemAF1.PassengerFare.Taxes.TaxSummary[i1a].TaxCode,
                                                                Amount = itemAF1.PassengerFare.Taxes.TaxSummary[i1a].Amount,
                                                                CurrencyCode = itemAF1.PassengerFare.Taxes.TaxSummary[i1a].CurrencyCode,
                                                                DecimalPlaces = itemAF1.PassengerFare.Taxes.TaxSummary[i1a].DecimalPlaces,
                                                                content = itemAF1.PassengerFare.Taxes.TaxSummary[i1a].content,
                                                                CountryCode = itemAF1.PassengerFare.Taxes.TaxSummary[i1a].CountryCode ?? "",
                                                                PassengerType = itemAF1.PassengerTypeQuantity.Code
                                                            };
                                                            objAF_Taxes2.TaxSummary.Add(objAF_TaxSummary1);
                                                        }
                                                        ...
                                                        objAF_PassengerFare.Taxes.Add(objAF_Taxes2);
                                                        MarkupParameters markupParms = new MarkupParameters();
                                                        if (itemAF1.PassengerTypeQuantity.Code == "ADT" || itemAF1.PassengerTypeQuantity.Code == "JCB" || itemAF1.PassengerTypeQuantity.Code == "ITX")
                                                        {
                                                            infantDefaultFare = itemAF1.PassengerFare.TotalFare.Amount;
                                                        }
